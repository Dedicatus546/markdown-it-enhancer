import { fromCodePoint, replaceCodePoint } from "./decode-codepoint";
...
export type DecodingModeType = (typeof DecodingMode)[keyof typeof DecodingMode];
...
export class EntityDecoder {
  ...
  private state: EntityDecoderStateType = EntityDecoderState.EntityStart;
  ...
  private decodeMode: DecodingModeType = DecodingMode.Strict;

  /** Resets the instance to make it reusable. */
  startEntity(decodeMode: DecodingModeType): void {
...
export function decodeHTML(
  htmlString: string,
  mode: DecodingModeType = DecodingMode.Legacy,
): string {
